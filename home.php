...
while($row = mysqli_fetch_assoc($result)){
    ...
    <img src="class.jpeg" class="card-img-top" >
    ...
    <div class="card-body">
      <a href="class_content_student.php?userid=' .$uid. '&classId=' .$Cid. '" class="btn btn-primary">ENTER CLASS</a>
    </div>
    </div>';
}
echo '</div>';
...
while($row3 = mysqli_fetch_assoc($result3)){
    ...
    <div class="card-body">
     <a href="class_content_admin.php?userid=' .$uid. '&classId=' .$Cid. '" class="btn btn-primary">ENTER CLASS</a>
    </div>
    </div>';
}
echo '</div>';
